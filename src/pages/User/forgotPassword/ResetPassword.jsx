...
function ResetPassword() {
  ...
  return (
    localStorage.getItem('resetPasswordStatus')? 
      ...
      <div className="forgot-form" style={forgotFormStyle}>
        ...
        <FloatLabel style={{ marginTop: "35px" }}>
            <InputText
              ...
              style={inputStyle}
            />
            <label htmlFor="password" style={{ marginBottom: 5, marginLeft: 250 }}>
              كلمة السر الجديدة
            </label>
          </FloatLabel>
   ...
   // if is not confirmed the reset password:  404 Not Found
    : <div className="container">
      <Navbar />
      <div className="forgot-form" style={forgotFormStyle}>
        <h3>لم تقم ب��رسال رابط التغيير للبريد ال��لكتروني</h3>
        <Link to="/forgot-password">��عادة التوجيه ��لى ��فحة التغيير</Link>
      </div>
      <Footer />
    </div>
  );
